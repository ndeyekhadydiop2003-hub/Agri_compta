...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center space-x-4 mb-8">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Ajouter une Variété</h2>
            <p class="text-gray-500">Créez un nouveau type de culture pour vos produits</p>
        </div>
    </div>

    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <form action="{{ route('varietes.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
